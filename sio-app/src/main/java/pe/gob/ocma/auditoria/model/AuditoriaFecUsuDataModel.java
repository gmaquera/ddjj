 ...
 * 15/10/2013 14:48:45
 */
public class AuditoriaFecUsuDataModel extends LazyDataModel<AuditoriaFechasModel> {
	 ...
	 */
	public AuditoriaFecUsuDataModel(AuditoriaService auService, String codUsuario, Date fechaInicio, Date fechaFin) {
		super();
	...
	public List<AuditoriaFechasModel> load(int first, int pageSize, String sortField,	SortOrder sortOrder, Map<String, String> filters) {
		WrappedData<AuditoriaFechasModel> wd = auService.buscarAuditoria(this.codUsuario, this.fechaInicio, this.fechaFin, first, pageSize);
