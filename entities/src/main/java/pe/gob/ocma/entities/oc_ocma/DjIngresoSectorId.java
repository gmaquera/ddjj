...
/**
 * DjIngresoSectorId generated by hbm2java
 */
@Embeddable
public class DjIngresoSectorId implements java.io.Serializable {
	...
	public DjIngresoSectorId() {
	}

	public DjIngresoSectorId(int codIngreso, int codBloque, int codDj,
			int codItem, int codCategoria, int codSector) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DjIngresoSectorId))
			return false;
		DjIngresoSectorId castOther = (DjIngresoSectorId) other;
		...
		return (this.getCodIngreso() == castOther.getCodIngreso())
				...
				&& (this.getCodSector() == castOther.getCodSector());
	}
	...
	public int hashCode() {
		...
		result = 37 * result + this.getCodSector();
		return result;
	}
