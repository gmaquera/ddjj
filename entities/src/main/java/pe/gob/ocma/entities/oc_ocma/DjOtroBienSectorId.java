...
/**
 * DjOtroBienSectorId generated by hbm2java
 */
@Embeddable
public class DjOtroBienSectorId implements java.io.Serializable {
	...
	public DjOtroBienSectorId() {
	}

	public DjOtroBienSectorId(int codSector, int codBien, int codBloque,
			int codDj) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DjOtroBienSectorId))
			return false;
		DjOtroBienSectorId castOther = (DjOtroBienSectorId) other;

		return (this.getCodSector() == castOther.getCodSector())
				&& (this.getCodBien() == castOther.getCodBien())
