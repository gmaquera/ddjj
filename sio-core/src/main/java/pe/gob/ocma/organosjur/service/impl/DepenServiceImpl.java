...
import pe.gob.ocma.organosjur.service.DepenService;
...
@Service("depenService")
public class DepenServiceImpl implements DepenService {

	@Autowired
	private DepenDao depenDao;
	
	@Override
	public List<Ojtsubespe> listarDepen() {
		return depenDao.searAll();
	}
